  ...
  const contactInfo = [
    {
      ...
      title: "Location",
      details: ["123 Tire Street", "Business District", "City, State 12345"]
    },
    {
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {contactInfo.map((info, index) => (
                <Card 
                  key={index} 
                  className={`bg-card-gradient border-0 shadow-lg cursor-pointer mt-1 hover:shadow-xl transition-all duration-300 ${info.action ? 'cursor-pointer hover:-translate-y-1' : ''}`}
                  onClick={info.action}
                >
            ...
            <Card className="bg-card-gradient border-0 shadow-xl">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-primary-gradient hover:bg-primary-dark text-primary-foreground py-3 text-lg font-semibold shadow-glow-primary transition-all duration-300"
                  >
                    Send Message
                  </Button>
